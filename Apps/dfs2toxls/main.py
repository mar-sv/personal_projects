...
import os
import sys
from myfunctions import dfs2toxlss
...
class FileSelectorGUI:
    def __init__(self, master):
        ...
        self.button3 = ttk.Button(
            master, text="Select output path and name", command=self.select_output_directory)
        ...
        self.button5 = ttk.Button(
            master, text="About", command=self.show_about)
    ...
    def run_script(self):
        ...
        dfs2toxlss(self.file1, self.file2, self.output_directory)
        self.prompt.insert(
            tk.END, 'Script completed, check your output directory')
